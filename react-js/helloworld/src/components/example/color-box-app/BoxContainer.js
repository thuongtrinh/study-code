...
class BoxContainer extends Component {
  ...
  changeColor(c) {
    ...
    do {
      ...
      // If new rgb color is equal to previous color of the box then again create new rgb color value
    } while (newColor === c);

    // Change colors array state by inserting new color value in place of previous color
    this.setState((st) => ({
