...
<head>
	...
	<link href="${css}/bootstrap.min.css" rel="stylesheet" type="text/html">
	<link href="${css}/font-awesome.min.css" rel="stylesheet" type="text/html">
	<link href="${css}/prettyPhoto.css" rel="stylesheet" type="text/html">
	<link href="${css}/price-range.css" rel="stylesheet" type="text/html">
	<link href="${css}/animate.css" rel="stylesheet" type="text/html">
	<link href="${css}/main.css" rel="stylesheet" type="text/html">
	<link href="${css}/responsive.css" rel="stylesheet" type="text/html">
	<!--[if lt IE 9]>
