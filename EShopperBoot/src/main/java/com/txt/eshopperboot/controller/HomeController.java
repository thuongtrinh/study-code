...
public class HomeController {
	...
	public String cart(@Valid @ModelAttribute("address") Address address, BindingResult resultAddress,
			@Valid @ModelAttribute("user") User user, BindingResult resultUser, Model model,
		...
		userRepository.updateJPQL(user.getUsername(), 
				user.getFirstName(), user.getLastName(), user.getPhone(),
				BLANK.equals(user.getMiddleName()) ? null : user.getMiddleName(),
				BLANK.equals(user.getMobilePhone()) ? null : user.getMobilePhone(),
				BLANK.equals(user.getFax()) ? null : user.getFax());
