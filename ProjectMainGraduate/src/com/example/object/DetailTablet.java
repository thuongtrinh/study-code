...
public class DetailTablet {

	private ParseFile avatar;
	private String condition, name, id, price;
	private String guarantee, state;
	private ArrayList<TabletNumber> tabletNumbers;
	private boolean saleOff;
	private int percentPromotion, SumTabletSold, SumTablet;

	public int getSumTablet() {
		return SumTablet;
	}

	public void setSumTablet(int sumTablet) {
		SumTablet = sumTablet;
	}
	...
	public ArrayList<TabletNumber> getTabletNumbers() {
		return tabletNumbers;
	}

	public void setTabletNumbers(ArrayList<TabletNumber> tabletNumbers) {
		this.tabletNumbers = tabletNumbers;
	}

	public int getSumTabletSold() {
		return SumTabletSold;
	}

	public void setSumTabletSold(int sumTabletSold) {
		SumTabletSold = sumTabletSold;
	}
