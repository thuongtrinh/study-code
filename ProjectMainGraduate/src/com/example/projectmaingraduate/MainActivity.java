...
import com.example.object.NavDrawerItem;
...
//		navDrawerItems.add(new NavDrawerItem(navMenuTitles[5], navMenuIcons.getResourceId(5, -1), true, "50+"));
		...
		if (savedInstanceState == null) {
			...
			// displayView(0);
			Fragment fragment = new StarterProjectFragment();
...
//			setTitle(navMenuTitles[0]);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_sign_in:
			startActivity(new Intent(getApplicationContext(), DialogSigninUser.class));
			return true;
		default:
	...
	private void displayView(int position) {
		...
		switch (position) {
			...
			case 1:
				...
				break;
			case 2:
				startActivity(new Intent(this, ComunicationActivity.class));
				break;
			default:
				break;
		}
