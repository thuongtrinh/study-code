...
public class UpdateDetailTabletManagerActivity extends Activity {
	...
	private DetailTablet detailTablet = new DetailTablet();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Bundle bundle = intent.getBundleExtra("UpdateTablet");
		final String idUpdate = bundle.getString("IdUpdateTablet");

		detailTablet = ParseApplication.getInforUpdateProductsTablet(idUpdate);
		refreshData();
		...
		btnVerify.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				AlertDialog.Builder builder = new AlertDialog.Builder(
						UpdateDetailTabletManagerActivity.this);
				...
				builder.setNegativeButton("Đúng vậy",
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if (ok && (saleOff.equalsIgnoreCase("true") || saleOff
							...
							detailTablet.setName(label);
							detailTablet.setSaleOff(b);
							detailTablet.setPrice(price);
							detailTablet.setGuarantee(guarantee);
							detailTablet.setState(state);
							detailTablet.setPercentPromotion(percent);
							boolean verify = ParseApplication
									.VerifyDataUpdateProduct("Tablet", idUpdate, label, price,
											percent, b, guarantee, state);
							if (verify) {
	...
	protected void refreshData() {
		if (detailTablet != null) {
			edtLabel.setText(detailTablet.getName());
			edtPrice.setText(detailTablet.getPrice());
			edtGuarantee.setText(detailTablet.getGuarantee());
			edtState.setText(detailTablet.getState());
			edtPercentPromption.setText(String.valueOf(detailTablet.getPercentPromotion()));
			edtSaleOff.setText(String.valueOf(detailTablet.isSaleOff()));
		}
	}
