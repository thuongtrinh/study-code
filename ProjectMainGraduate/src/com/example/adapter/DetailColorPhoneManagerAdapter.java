...
public class DetailColorPhoneManagerAdapter extends ArrayAdapter<PhoneNumber>{
	
	private ArrayList<PhoneNumber> arrayList;
	...
	public DetailColorPhoneManagerAdapter(Activity context, ArrayList<PhoneNumber> objects) {
