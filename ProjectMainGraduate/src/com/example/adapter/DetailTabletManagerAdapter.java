...
public class DetailTabletManagerAdapter extends ArrayAdapter<DetailTablet> {
	...
	public DetailTabletManagerAdapter(Activity context, ArrayList<DetailTablet> objects) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		tvNumber.setText(String.valueOf(arrayList.get(position).getSumTablet()));
		tvNumberSold.setText(String.valueOf(arrayList.get(position).getSumTabletSold()));
