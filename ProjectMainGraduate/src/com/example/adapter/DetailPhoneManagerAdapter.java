...
public class DetailPhoneManagerAdapter extends ArrayAdapter<DetailPhone> {
	...
	public DetailPhoneManagerAdapter(Activity context,
			ArrayList<DetailPhone> objects) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		tvNumber.setText(String.valueOf(arrayList.get(position).getSumPhone()));
		tvNumberSold.setText(String.valueOf(arrayList.get(position).getSumPhoneSold()));
